...
// • Print your array in revers alphabetical order without changing the order of the original list.
...
let locations = ['Pakistan', 'Turkey', 'Australia', 'Saudi Arabia', 'China'];
